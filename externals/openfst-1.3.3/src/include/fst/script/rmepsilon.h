...
// 1
void OPENFSTDLL RmEpsilon(const FstClass &ifst, MutableFstClass *ofst, //ChangedPD
               bool reverse = false,
               const RmEpsilonOptions& opts =
                 fst::script::RmEpsilonOptions());

// 2
void OPENFSTDLL RmEpsilon(MutableFstClass *arc, bool connect = true, //ChangedPD
...
// 3
void OPENFSTDLL RmEpsilon(MutableFstClass *fst, vector<WeightClass> *distance, //ChangedPD
               const RmEpsilonOptions &opts);
