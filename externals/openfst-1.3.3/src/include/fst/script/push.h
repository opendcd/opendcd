...
// 1
void OPENFSTDLL Push(MutableFstClass *ofst, ReweightType type, float delta = kDelta, //ChangedPD
          bool remove_total_weight = false);

// 2
void OPENFSTDLL Push(const FstClass &ifst, MutableFstClass *ofst, uint32 flags, //ChangedPD
