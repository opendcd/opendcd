...
// 1
void OPENFSTDLL ShortestDistance(const FstClass &fst, vector<WeightClass> *distance, //ChangedPD
                      const ShortestDistanceOptions &opts);

// 2
void OPENFSTDLL ShortestDistance(const FstClass &ifst, vector<WeightClass> *distance, //ChangedPD
                      bool reverse = false, double delta = fst::kDelta);

#ifndef SWIG
// 3
WeightClass OPENFSTDLL ShortestDistance(const FstClass &ifst); //ChangedPD
#endif
