...
// 1
void OPENFSTDLL Prune(MutableFstClass *fst, const PruneOptions &opts); //ChangedPD

// 2
void OPENFSTDLL Prune(const FstClass &ifst, MutableFstClass *fst, //ChangedPD
           const PruneOptions &opts);

// 3
void OPENFSTDLL Prune(const FstClass &ifst, MutableFstClass *ofst, //ChangedPD
           const WeightClass &weight_threshold,
           int64 state_threshold = kNoStateId,
           float delta = kDelta);

// 4
void OPENFSTDLL Prune(MutableFstClass *fst, const WeightClass& weight_threshold, //ChangedPD
