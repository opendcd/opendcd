...
FarEntryType OPENFSTDLL StringToFarEntryType(const string &s); //ChangedPD
FarTokenType OPENFSTDLL StringToFarTokenType(const string &s); //ChangedPD

// Return the 'FarType' value corresponding to a far type name.
FarType OPENFSTDLL FarTypeFromString(const string &str); //ChangedPD

// Return the textual name  corresponding to a 'FarType;.
string OPENFSTDLL FarTypeToString(FarType type); //ChangedPD

string OPENFSTDLL LoadArcTypeFromFar(const string& far_fname); //ChangedPD
string OPENFSTDLL LoadArcTypeFromFst(const string& far_fname); //ChangedPD
