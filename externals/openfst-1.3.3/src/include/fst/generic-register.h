...
class GenericRegister {
 ...
 private:
  ...
  OPENFSTDLL static FstOnceType register_init_; //ChangedPD
  OPENFSTDLL static Mutex *register_lock_; //ChangedPD
  OPENFSTDLL static RegisterType *register_; //ChangedPD
