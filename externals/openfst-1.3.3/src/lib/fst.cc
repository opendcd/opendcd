...
OPENFSTDLL FstReadOptions::FstReadOptions(const string& src, const FstHeader *hdr,
...
OPENFSTDLL FstReadOptions::FstReadOptions(const string& src, const SymbolTable* isym,
