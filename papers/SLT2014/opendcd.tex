...
Goals of the OpenDcd toolkit:
\textbf{Simplicity}
\begin{itemize}
  \item Concise code - only 5000 lines
  \item It \emph{just works} simple to build with make
  \item No build dependencies 
  \item One decoding command
  \item Streamlined
\end{itmemize}
\section{Overview}
\label{sec:format}
